<%@ Page Title="Singleproduct" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Singleproduct.aspx.cs" Inherits="WebApplication_1.Singleproduct" %>
...
<!-- ========================================= BREADCRUMB : END ========================================= --></div>     <div id="single-product">
    ...
    <div class="body">
        ...
        <div class="qnt-holder">
            ...
            <a id="addto-cart" href="cart.html.html" class="le-button huge">add to cart</a>
        </div><!-- /.qnt-holder -->
    </div><!-- /.body -->
